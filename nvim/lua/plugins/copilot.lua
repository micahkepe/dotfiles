return {
  -- OPTION 1: use copilot as a completion source (with inline ghost text)
  -- This is my preferred option and replicates the behavior of the official
  -- "github/copilot.vim" plugin and Visual Studio Code extension.
  --
